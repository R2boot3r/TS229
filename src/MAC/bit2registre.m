...
%% Variables
tableau_char = '_ABCDEFGHIJKLMNOPQRSTUVWXYZ _______________0123456789';
...
if error_flag == 0 % prise en compte des tram sans erreurs, aucune erreur sur les donné
    ...
    if DF == 17
        ...
        if registre_input.type >= 1 && registre_input.type <= 4
           ...
           char1 = bi2de(ADS(9:14));
           char2 = bi2de(ADS(15:20));
           char3 = bi2de(ADS(21:26));
           char4 = bi2de(ADS(27:32));
           char5 = bi2de(ADS(33:38));
           char6 = bi2de(ADS(39:44));
           char7 = bi2de(ADS(45:50));
           char8 = bi2de(ADS(51:56));
